...
<body>
    ...
    <form action="process_register.php" method="POST">
        ...
        <input type="text" name="fullname" placeholder="Firstname MI Surname" require><br><br>

        <label for="username">Username:</label><br>
        <input type="text" name="username" require><br><br>

        <label for="phonenumber">Phone Number:</label><br>
        <input type="number" name="phonenumber" require><br><br>

        <label for="civilStatus">Civil Status:</label><br>
        <input type="text" name="civilStatus" require><br><br>
